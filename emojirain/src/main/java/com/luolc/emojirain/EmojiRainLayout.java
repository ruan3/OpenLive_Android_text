...
public class EmojiRainLayout extends PercentFrameLayout {
    ...
    private Pools.SynchronizedPool<ImageView> mEmojiPool;//对象池，如果你的对象需要内存资源很大，就可以用到对象池保存，不用每次都创建对象
    ...
    public void startDropping() {
        ...
        /**
         * 这里用到了RxJava，这个方法主要作用是
         * 缓存数据和发射数据
         * Observable.interval，通过时间间隔来发射数据，每个多少毫秒发射一次数据
         */
